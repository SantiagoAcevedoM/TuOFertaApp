...
public interface EditarApi {
    ...
    @ApiOperation(value = "editar un usuario", nickname = "editarPut", notes = "se edita un usuario", response = JsonApiBodyResponseSuccess.class, tags={ "persona", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Persona editado", response = JsonApiBodyResponseSuccess.class),
